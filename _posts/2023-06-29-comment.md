...
<!-- cross linking to a BlueSky post about a blog post -->
    {% if page.bluesky_post_url %}
      <div id="bluesky-comment-section" style="margin-top: 40px;">
        <h2>Say Hi on Bluesky  <a href="/"><img src="/assets/images/fav2.png" width="22px;" style="float: left; margin-left: 0px; margin-right: 5px; margin-top: 5px; margin-bottom: 0px; padding: 0px; border: 0px;" /></a></h2>
