...
> Update 2023.06.12 version 2 of script with color added to text for emphasis: [arcadyan-wifi-v2](https://github.com/verity-s/verity-s.github.io/blob/main/T-Mobile/arcadyan-wifi-v2.py).
...
[Direct link to my script version 1](https://github.com/verity-s/verity-s.github.io/blob/main/T-Mobile/arcadyan-wifi-v1.py) or if you prefer, check out the [raw view of my script version 1](https://raw.githubusercontent.com/verity-s/verity-s.github.io/main/T-Mobile/arcadyan-wifi-v1.py).
...
Af you encounter any issues, ask on [my GitHub issues page](https://github.com/verity-s/verity-s.github.io/issues) or [leave a friendly comment](https://github.com/verityj/verityj.github.io/discussions/1).
