...
First, let's understand what the _eject_ (⏏) key is. Eject on the Magic keyboard is a _consumer one shot control (OSC)_ key. The official function is _"OSC - removes media from the player"_.[^1] Ha, remember when we had computers with CD drives?
...
<img class="centered" style="width: 50%; border: unset;" src="/assets/images/2023-06-17a.png" />
